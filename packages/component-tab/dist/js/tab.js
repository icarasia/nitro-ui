...
var _tab = _interopRequireDefault(require("bootstrap/js/src/tab"));

var _util = _interopRequireDefault(require("bootstrap/js/src/util"));
...
/*#__PURE__*/
function (_Tab) {
  _inherits(NitroTab, _Tab);

  function NitroTab() {
    _classCallCheck(this, NitroTab);

    return _possibleConstructorReturn(this, _getPrototypeOf(NitroTab).apply(this, arguments));
  }

  _createClass(NitroTab, [{
    key: "show",
    // Getters
    // static get VERSION() {
    //   return VERSION
...
(0, _jquery["default"])(document).unbind('click.bs.tab.data-api') // Unbind Bootstrap Tab API
.on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, function (event) {
  event.preventDefault();

  NitroTab._jQueryInterface.call((0, _jquery["default"])(this), 'show');
});
/**
 * ------------------------------------------------------------------------
 * jQuery
...
_jquery["default"].fn[NAME] = NitroTab._jQueryInterface;
_jquery["default"].fn[NAME].Constructor = NitroTab;
